...
namespace brevo_csharp.Api
{
    ...
    public partial class EmailCampaignsApi : IEmailCampaignsApi
    {
        ...
        /// <returns></returns>
        public EmailCampaignsApi(brevo_csharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteEmailCampaignWithHttpInfo (long? campaignId)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Configuration.ApiClient.CallApi(localVarPath,
                HttpMethod.Delete, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarFileParams,
                localVarPathParams, localVarHttpContentType);
